...
const HomeContentAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const url = editId ? `/api/admin/home-content/${editId}` : "/api/admin/home-content";
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Are you sure you want to delete this home content personalization?")) return;
    try {
      const res = await fetch(`/api/admin/home-content/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("admin-token")}`,
        },
    ...
    <div className="chart-card">
      ...
      {showForm && (
        <div className="card mb-4 shadow-sm border-0 bg-light">
          <div className="card-body">
            <h5 className="mb-3 text-primary">{editId ? "Edit Personalized Content" : "Add Personalized Content"}</h5>
            <form onSubmit={handleSubmit}>
              <div className="row g-3">
                {/* Geo targeting targeting */}
                ...
                <div className="col-md-4">
                  <label className="form-label fw-bold">Priority (Higher runs first)</label>
                  <input
                    type="number"
                    className="form-control"
                    name="priority"
                ...
                <div className="col-md-6">
                  <label className="form-label fw-bold">Primary Button Text</label>
                  <input
                    type="text"
                    className="form-control"
                    name="heroButtonText"
                ...
                <div className="col-md-6">
                  <label className="form-label fw-bold">Secondary Button Text</label>
                  <input
                    type="text"
                    className="form-control"
                ...
                <div className="col-md-6">
                  <label className="form-label fw-bold">Home Background Video URL</label>
                  <input
                    type="text"
                    className="form-control"
                ...
                <div className="col-md-6">
                  <label className="form-label fw-bold">Home Background Image URL</label>
                  <input
                    type="text"
                    className="form-control"
                ...
                {/* Emergency & Stats */}
                <div className="col-md-12">
                  <label className="form-label fw-bold">Emergency Banner Text (Displays pulse alert on landing page)</label>
                  <input
                    type="text"
                ...
                <div className="col-md-12">
                  <label className="form-label fw-bold">Local Impact Text</label>
                  <input
                    type="text"
                    className="form-control"
                ...
                <div className="col-md-4">
                  <label className="form-label fw-bold">Local Active Donors Count</label>
                  <input
                    type="number"
                    className="form-control"
                ...
                <div className="col-md-4">
                  <label className="form-label fw-bold">Local Blood Banks Count</label>
                  <input
                    type="number"
                    className="form-control"
      ...
      {!showForm && (
        <div className="custom-table-container">
          {loading ? (
            <p className="text-center py-4 text-muted">Loading personalized contents...</p>
          ) : items.length === 0 ? (
            <p className="text-center py-4 text-muted">No personalized contents found. Create your first targeting rule.</p>
          ) : (
                  ...
                  <tr key={item._id}>
                    ...
                    <td>
                      {item.emergencyBannerText ? (
                        <span className="text-danger small fw-bold">{item.emergencyBannerText}</span>
                      ) : (
